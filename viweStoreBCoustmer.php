...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	...
	body
	{
		background-image: url("Images/customerother.jpg");
...
<ul>
  ...
  <tr>
    ...
    <td height="198" colspan="2" align="center" >
		<p>&nbsp;</p>
		<table width="583" height="223" border="0">
      <tbody>
        <tr>
          <td width="577" align="center"><img src="Images/adminothers2.jpg" width="216" height="261" alt=""/>
      ...
      <table width="262" height="42" border="0">
        <tbody>
          <tr>
            <td><h1 align="center" style="color: #2C3A23; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;"><span style="color: #FFFFFF; font-family: Consolas, 'Andale Mono', 'Lucida Console', 'Lucida Sans Typewriter', Monaco, 'Courier New', monospace; font-size: 40px;">Studio Mics &amp; Monitors </span></h1></td>
          </tr>
        </tbody>
      </table>
