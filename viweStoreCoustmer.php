...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	...
	body
	{
		background-image: url("Images/customerkeyboard.jpg");
...
<table width="650" height="256" border="0" align="center">
  <tr>
   <td width="354" align="center" ><img src="Images/Untitled-1.png" width="261" height="66" alt=""/></td>
    <td width="289"><div>
<ul>
  ...
  <tr>
    ...
    <td height="198" colspan="2" align="center" >
		   <p>&nbsp;</p>
		   <table width="636" height="223" border="0">
      <tbody>
        <tr>
          <td width="630" height="219" align="center"><img src="Images/Adminkeyboard2.jpg" width="330" height="210" alt=""/><img src="Images/adminkeyboard1.jpg" width="216" height="211" alt=""/></td>
        </tr>
      </tbody>
    </table>
      <table width="262" height="42" border="0">
        <tbody>
          <tr>
            <td><h1 align="center" style="color: #2C3A23; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;"><span style="color: #FFFFFF; font-family: Consolas, 'Andale Mono', 'Lucida Console', 'Lucida Sans Typewriter', Monaco, 'Courier New', monospace; font-size: 40px;">Midi,KeyBoards &amp; Pianos</span></h1></td>
          </tr>
        </tbody>
      </table>
        ...
        <td width="521">
            <table width="512">
              ...
              <tr>
                ...
                <p><a href='viweStoreCoustmer?id=".$row['id']."'><button type='submit' name='btnsubmit'  ><i class='fa fa-cart-arrow-down' aria-hidden='true'></i>Add to Cart</button></a></p></td>
